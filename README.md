...
| Model | mAP<sup>val<sub>50</sub></sup><br>(%) | mAP<sup>val<sub>50:95</sub></sup><br>(%) | mAP<sup>test<sub>50</sub></sup><br>(%) | mAP<sup>test<sub>50:95</sub></sup><br>(%) | Params<br>(M) | FLOPs<br>(G) | Latency<br>(ms) |
|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
